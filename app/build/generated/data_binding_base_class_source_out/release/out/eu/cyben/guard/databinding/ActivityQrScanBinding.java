...
public final class ActivityQrScanBinding implements ViewBinding {
  ...
  private ActivityQrScanBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnClose,
  ...
  public static ActivityQrScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityQrScanBinding((ConstraintLayout) rootView, btnClose, viewFinder);
    }
