...
data class AnalyzeRequest(val text: String, val type: String, val chatHistory: List<Map<String, String>> = emptyList(), val preferredLanguage: String = java.util.Locale.getDefault().language, val sender: String? = null, val isKnownContact: Boolean? = null, val callSessionId: String? = null, val isLive: Boolean? = null, val mode: String? = null, val systemPrompt: String? = null)
