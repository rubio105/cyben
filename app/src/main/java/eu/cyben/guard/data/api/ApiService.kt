...
data class AnalyzeRequest(val text: String, val type: String, val chatHistory: List<Map<String, String>> = emptyList(), val preferredLanguage: String = java.util.Locale.getDefault().language, val callSessionId: String? = null, val isLive: Boolean? = null, val mode: String? = null)
